...
namespace Genetic_Algorithm
{
    public class GeneticAlgorithm
    {
        ...
        public GeneticAlgorithm(int _populationsize, int _numberGenerations, 
                                int _probabilityCrossover, int _probabilityMutation, 
                                int _selectionType, int _crossoverType,
                                int _functionType, int _optimizationType,
                                int _rangeMin, int _rangeMax, int _granularity, 
                                Random _random)
        {
